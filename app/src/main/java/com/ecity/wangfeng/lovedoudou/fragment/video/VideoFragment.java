...
import com.ecity.wangfeng.lovedoudou.presenter.video.VideoPresenter;
import com.ecity.wangfeng.lovedoudou.presenter.video.VideoPresenterImpl;
...
public class VideoFragment extends BaseFragment<VideoPresenter> implements VideoView {
	...
	public void initViews(View view) {
		mListener.onVideoTitle(getString(R.string.str_video));
...
//					}
	...
	private void setViewPager(List<String> channelNames) {
		PostFragmentPagerAdapter adapter = new PostFragmentPagerAdapter(getChildFragmentManager(), channelNames, mVideoFragmentList);
