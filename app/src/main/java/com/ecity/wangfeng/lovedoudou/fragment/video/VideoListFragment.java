package com.ecity.wangfeng.lovedoudou.fragment.video;
...
import com.ecity.wangfeng.lovedoudou.adapter.VideoListAdapter;
...
import com.ecity.wangfeng.lovedoudou.presenter.video.VideoListPresenter;
import com.ecity.wangfeng.lovedoudou.presenter.video.VideoListPresenterImpl;
import com.ecity.wangfeng.lovedoudou.util.playvideo.IjkVideoView;
...
/**
 * A simple {@link Fragment} subclass. Use the {@link VideoListFragment#newInstance} factory method to create an instance of this fragment.
 */
		...
		mVideoListView.addOnChildAttachStateChangeListener(new RecyclerView.OnChildAttachStateChangeListener() {
			...
			public void onChildViewAttachedToWindow(View view) {
				...
				if (position == mLastPosition) {
					...
					FrameLayout frameLayout = (FrameLayout) view.findViewById(R.id.item_layout_video);
					frameLayout.removeAllViews();
					if (mVideoPlayView != null && (mVideoPlayView.isPlay() || mVideoPlayView.VideoStatus() == IjkVideoView.STATE_PAUSED)) {
